...
For full versioning information, please refer to the [versioning documentation](../versioning).
...
You may not want to generate *all* models in your project.  Likewise you may want just one or two apis to be written. If that's the case check the [selective generation](../generation-selective) instructions.
